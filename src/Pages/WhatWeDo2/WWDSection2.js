...
const WWDsection2 = () => {
  return (
    <div className={classes.section_2}>
      <div className={classes.section1_innerWrapper}>
        <div className={classes.retail_space}>
          ...
          <p className={classes.Pdiv}>
            Our nealry 5200 square metre production facility with state of the
            art machinery.
          </p>
        </div>
        ...
        <div className={classes.last2Cards}>
          ...
          <Card
            ...
            card_text={
              "Our state of the art CNC systems, allow us the ability to increase productivity without compromising quality and tolerances. "
            }
          />
